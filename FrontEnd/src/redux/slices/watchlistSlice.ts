...
export const fetchWatchlist = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch('https://mini-youtube-fdhn.onrender.com/api/watchlist', {
        headers: {
...
export const addToWatchlist = createAsyncThunk(
  ...
  async (videoId: string, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(`https://mini-youtube-fdhn.onrender.com/api/watchlist/${videoId}`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        },
      ...
      if (!response.ok) {
       ...
       await response.json();
      const videoResponse = await fetch(`https://mini-youtube-fdhn.onrender.com/api/public/videos`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
