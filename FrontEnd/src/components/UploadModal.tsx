    ...
    if (isOpen) {
      const fetchCategories = async () => {
        try {
          ...
          const response = await fetch('https://mini-youtube-backend-hnra.onrender.com/api/admin/categories', {
            headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = selectedVideo
        ? `https://mini-youtube-backend-hnra.onrender.com/api/admin/videos/${selectedVideo.videoId}`
        : 'https://mini-youtube-backend-hnra.onrender.com/api/admin/videos';
